...
(function () {
  ...
  var translations = {
    zh: {
      ...
      'feat-sdk-desc': '按设备提供图形、输入、音频、文件、资源、任务和同步等高层模拟服务，并按 A330 帧缓冲来源处理像素格式。',
    ...
    en: {
      ...
      'feat-sdk-desc': 'Device-specific high-level services for graphics, input, audio, files, resources, tasks, and synchronization, with source-aware A330 framebuffer formats.',
