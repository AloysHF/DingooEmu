...
(function () {
  ...
  var translations = {
    zh: {
      ...
      'feat-mips-desc': 'A320 使用缓存 MIPS32 解释器，并可在 64 位 Android 上启用 JIT；A330 使用纯 Rust ARM32/Thumb 解释器。',
      'feat-sdk-title': '设备 SDK HLE',
      'feat-sdk-desc': '按设备提供图形、输入、音频、文件、资源、任务和同步等高层模拟服务。',
    ...
    en: {
      ...
      'feat-mips-desc': 'A320 uses the cached MIPS32 interpreter with an optional 64-bit Android JIT; A330 uses the pure Rust ARM32/Thumb interpreter.',
      'feat-sdk-title': 'Device SDK HLE',
      'feat-sdk-desc': 'Device-specific high-level services for graphics, input, audio, files, resources, tasks, and synchronization.',
