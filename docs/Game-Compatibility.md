...
| `Overlord-Fighter.app` | Partial | The title menu renders correctly with A320 model detection, resource metadata decoding, and planar YUV422 IPU conversion in standalone screenshot mode. |
